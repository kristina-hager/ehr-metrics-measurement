...
Necessarily, this question is best asked at the executive level of the organization and not at the developer level.
...
While these are all valid goals, they may or may not be in support of the most important business objectives.
...
Readers from a software background may be familiar with Victor Basili and Dieter Rombach's seminal work establishing a goal-driven measurement process called the Goal-Question-Metric (GQM) methodology \cite{TODO}.
...
Worse, the tracking of a not well though out metric may push the developers to focus on improving this metric and miss an opportunity to focus on improvements that could improve the business viability of the product.

\subsection{Intordoucing the GQ(I)M Methodology for an EHR-SaaS Product}
...
%Once basic functionality is verified, the product owner (and product buyers) need to determine what business level objectives are most important.
