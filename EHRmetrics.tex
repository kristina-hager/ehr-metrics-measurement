...
There is a saying in the medical field: "When you have seen one medical practice, you have seen one medical practice" that strongly reinforces this concern \cite{health-hack}.
...
However, it will be nearly impossible to expect practices from disparate specialrties such as pediatrics vs. oncology to converge to the same workflows.
